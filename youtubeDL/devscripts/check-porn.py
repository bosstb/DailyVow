...
from applications.CrideoCMS.modules.youtube_dl import compat_urllib_parse_urlparse
from applications.CrideoCMS.modules.youtube_dl import compat_urllib_request
